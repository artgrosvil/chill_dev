...
<div class="container">
	...
	<div class="row c-p-app">
		<form class="form-horizontal" id="form-c-p-app-create" method="post" accept-charset="utf-8">
			<div class="col-lg-3 col-lg-offset-1 c-p-avatar">
				<img src="http://cdn.iamchill.co/statics/avatars/avatar.png" id="avatar_app">
