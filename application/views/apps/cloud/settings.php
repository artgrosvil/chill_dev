			...
			<form class="form-horizontal" id="form-c-p-app-update" method="post" accept-charset="utf-8">
				...
				<div class="col-lg-7">
					...
					<div class="form-group c-p-padding">
						...
						<div class="col-lg-10">
							<input type="text" class="form-control" id="name" name="name" placeholder="<?= $data->name; ?>">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<select class="form-control" id="language" name="language">
								<option value="python" <?php if ($data->language == 'python'): ?>selected="selected"<?php endif; ?>>Python</option>
								<option value="php" <?php if ($data->language == 'php'): ?>selected="selected"<?php endif; ?>>PHP</option>
								<option value="ruby" <?php if ($data->language == 'ruby'): ?>selected="selected"<?php endif; ?>>Ruby</option>
							</select>
						</div>
					</div>
					<div class="form-group">
